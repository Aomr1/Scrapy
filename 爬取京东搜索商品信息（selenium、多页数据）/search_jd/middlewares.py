...
class SearchJdSpiderMiddleware:
...
class SearchJdDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
    ...
    def process_request(self, request, spider):
        if spider.name == "search":
            ...
            try:
                ...
                res = HtmlResponse(url=request.url, encoding='utf8', body=origin_code, request=request,status=200)
                return res
